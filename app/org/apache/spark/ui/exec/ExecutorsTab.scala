...
class ExecutorsListener(storageStatusListener: StorageStatusListener, conf: SparkConf)
  ...
  var executorToTasksActive: Int = 0
  var executorToTasksFailed: Int = 0
  var executorToTasksComplete: Int = 0
  var executorToDuration: Long = 0
  var executorToInputBytes: Long = 0
  var executorToShuffleRead: Long = 0
  var executorToShuffleWrite: Long = 0
  ...
  override def onTaskStart(taskStart: SparkListenerTaskStart): Unit = synchronized {
    ...
    executorToTasksActive = taskSummary.tasksActive
  }
  ...
  override def onTaskEnd(taskEnd: SparkListenerTaskEnd): Unit = synchronized {
    ...
    if (info != null) {
      ...
      executorToTasksActive = taskSummary.tasksActive
      executorToTasksFailed = taskSummary.tasksFailed
      executorToTasksComplete = taskSummary.tasksComplete
      executorToDuration = taskSummary.duration
      ...
      if (metrics != null) {
        ...
        executorToInputBytes = taskSummary.inputBytes
        executorToShuffleRead = taskSummary.shuffleRead
        executorToShuffleWrite = taskSummary.shuffleWrite
      }
    }
  }
